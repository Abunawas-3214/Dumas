...
<div class="main__content ticket">
    <div class="ticket__body" <?php echo ($hesk_settings['limit_width'] ? 'style="max-width:' . $hesk_settings['limit_width'] . 'px"' : ''); ?>>
        ...
        if ($ticket['status'] == 3) {
            ...
            // $status_action = '[<a href="admin_main.php">' . $hesklang['close_action'] . '</a>]';
        }
        ?>
    </div>
    <div class="ticket__params">
            ...
            <?php if (strlen($status_action)): ?>
                <div class="row">
                    ...
                    <div class="value center out-close">
                        <!-- <a href="admin_main.php"> Kembali</a> -->
        ...
        if (!empty($ticket['email'])) {
            ...
            ?>
            <section class="params--block details accordion <?php if ($past_num > 0)
                echo 'visible'; ?>">
                <h4 class="accordion-title">
                ...
                <div class="accordion-body" <?php if ($past_num > 0)
